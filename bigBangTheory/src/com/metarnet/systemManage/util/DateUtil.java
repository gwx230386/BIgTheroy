...
public class DateUtil extends org.apache.commons.lang.time.DateUtils {
     ...
     * 默认的时间格式化样式
     */
    public static final String DAY_TIME_PATTERN = "yyyyMMddHHmmss";
    /**
     * 将Date格式化成符合默认格式的字符串
     * 
     * @param date
    ...
    public static String formatDayTime(Date date) {
        SimpleDateFormat formatTool = new SimpleDateFormat();
        formatTool.applyPattern(DAY_TIME_PATTERN);
        return formatTool.format(date);
    }
    ...
    /**
     * @Description: 20151029162357 
     * @author: lcgu
     * @param dateValue
     * @return  2012-03-29 14:32:23
     * @throws ParseException
     * @date: 2015-10-29 下午4:29:37
     */
    public static String formatString(String time) throws ParseException {
		SimpleDateFormat sdf1 = new SimpleDateFormat(DAY_TIME_PATTERN);
		SimpleDateFormat sdf2 = new SimpleDateFormat(DAY_PATTERN+" "+TIME_PATTERN);
		Date d1 = sdf1.parse(time);
		String sValue = sdf2.format(d1);
		return sValue;
    } 
